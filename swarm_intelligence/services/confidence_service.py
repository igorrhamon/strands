...
class ConfidenceService:
    ...
    def record_confidence_snapshot(self, agent_id: str, value: float, source_event: str, sequence_id: int, cause_id: str = None, cause_type: str = None):
    ...
    def apply_time_decay(self, agent_id: str, sequence_id: int, decay_rate: float):
        ...
        self.record_confidence_snapshot(agent_id, decayed_value, "time_decay", sequence_id, cause_id=agent_id, cause_type="SystemEvent")

    def penalize_for_override(self, agent_id: str, decision_id: str, sequence_id: int, policy: ConfidencePolicy):
        ...
        self.record_confidence_snapshot(agent_id, penalized_value, "human_override", sequence_id, cause_id=decision_id, cause_type="Decision")

    def reinforce_for_success(self, agent_id: str, decision_id: str, sequence_id: int, policy: ConfidencePolicy):
        ...
        self.record_confidence_snapshot(agent_id, reinforced_value, "successful_outcome", sequence_id, cause_id=decision_id, cause_type="Decision")
